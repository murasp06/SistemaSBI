...
<?php
  if ($_GET['id'] == 01) { //confirmacion de el registro
    echo '<div class="alert alert-success alert-dismissible fade show" role="alert">Registro de Proveedor Exitoso!
      <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
      </div>';
  } elseif ($_GET['id'] == 02) {
    echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">No se pudo registrar el Proveedor!
      <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
      </div>';
  };
  ?>
  <div class="border border-dark">
    ...
    <div class="container border-bottom bg-dark border-dark d-flex justify-content-between ">
      <div class="">
        <h3 class="text-white">Libreta Proveedores</h3>
      </div>
      <div class="p-2">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div style="background-color: #ff3333;" class="modal-body">
                <!-- formulario -->
                <form action="../Controller/con.insertproveedor.php" method="post">
                  <div class="d-flex">
                    <div class="form-floating mb-3 mx-1">
                      <input type="text" class="form-control" id="1" name="proveedor" placeholder="nombre apellido" required>
                      <label for="1">Nombre Proveedor</label>
                    </div>
                  ...
                  <div>
                    <div class="form-floating mb-3">
                      <input type="number" class="form-control" id="5" name="nit" placeholder="1'000.000">
                      <label for="5">NIT</label>
                    </div>
                  </div>
              </div>
      ...
      <div class="table-responsive-md">
        <table class="table table  table-striped border-dark table-responsive">
          ...
          <tbody>
            ...
            if ($consul_proveedores >= 1) {

              foreach ($consul_proveedores as $proveedores) {


            ?>
                <tr>
                  <th style="color: #ff3333;" scope="row"><?php echo $proveedores-> codx ?></th>
                  <td><?php echo $proveedores-> proveedor ?></td>
                  <td><?php echo $proveedores-> nit ?></td>
                  <td><?php echo $proveedores-> movil ?></td>
            ...
            } $sql= null; $consul_proveedores= null; $proveedores= null; ?>
          </tbody>
        </table>
      </div>
      <!-- paginacion -->
      <nav class=" d-flex justify-content-between mb-4" aria-label="Page navigation example">
        <div> <span>mostrando 15 de x Provee.</span> </div>
        <ul class="pagination ">
          <li class="page-item">
